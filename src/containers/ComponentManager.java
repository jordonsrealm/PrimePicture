...
public class ComponentManager {
	...
	private static final String GENERATE_PICTURE = "Create Picture";
	private static final String ENDS_WITH_1 = "Ends with 1";
	private static final String ENDS_WITH_3 = "Ends with 3";
	private static final String ENDS_WITH_7 = "Ends with 7";
	private static final String ENDS_WITH_9 = "Ends with 9";
	
	private static JTextField heightField = new JTextField();
	private static JTextField widthField = new JTextField();
	
	private static JButton chooser1 = new JButton(ENDS_WITH_1);
	private static JButton chooser3 = new JButton(ENDS_WITH_3);
	private static JButton chooser7 = new JButton(ENDS_WITH_7);
	private static JButton chooser9 = new JButton(ENDS_WITH_9);
	...
	private static JButton generatePic    = new JButton(GENERATE_PICTURE);
	...
	public static String getGeneratePicture() {
